...
export default class Dissolve {
  ...
  _createRenderer() {
	...
	_changeImg() {
		...
		this.frontDiffuseMapLoader.load("/sketch/assets/resource/img/dissolve01.png", function (frontMap) {
			this.backDiffuseMapLoader.load("/sketch/assets/resource/img/dissolve02.png", function (backMap) {
				this.heightMapLoader.load("/sketch/assets/resource/img/0a4h0.png", function (heightMap) {
